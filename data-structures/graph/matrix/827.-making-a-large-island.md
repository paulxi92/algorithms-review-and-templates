...
//                 }
//                 hasZero = true;
//                 res = Math.max(res, getSize(i, j, grid));
//             }
//         }
//         return hasZero ? res : m * n;
//     }

//     private void helper(int r, int c, int idx, int[][] grid) {
//         int m = grid.length, n = grid[0].length;
//         ++cnt;
//         grid[r][c] = idx;
//         for (int[] dir : dirs) {
...
//     private int getSize(int r, int c, int[][] grid) {
//         int m = grid.length, n = grid[0].length;
