    ...
    public List<String> findWords(char[][] board, String[] words) {
        ...
        for (int i = 0; i < m; ++i) {
            for (int j = 0; j < n; ++j) {
                ...
                helper(root.child[idx], i, j, visited, board);
            }
        }
        return res;
    }

    private void helper(TrieNode cur, int r, int c, boolean[][] visited, char[][] board) {
        if (cur.word != null) {
            res.add(cur.word);
            cur.word = null; // avoid duplicates
        }
        int m = board.length, n = board[0].length;
        ...
        for (int[] dir : dirs) {
            ...
            int idx = board[x][y] - 'a';
            if (cur.child[idx] != null) {
                helper(cur.child[idx], x, y, visited, board);
            }
        }
        visited[r][c] = false;
    }
